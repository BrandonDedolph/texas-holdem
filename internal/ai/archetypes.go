...
// Each exists to teach one specific lesson, noted in its Blurb. The numbers
// follow the design table: Range / Aggression / Bluff / CallDown / CBet.
//
...
var Archetypes = map[string]Personality{
	...
	"tag": {
		Key: "tag", Label: "Tight-Aggressive",
	...
	"lag": {
		Key: "lag", Label: "Loose-Aggressive",
